...
export interface TransactionTrackingDataSellerDataOnlineOrCrmDataPopulated { 
    sellingCompany?: CompanyEmbeddedInTransaction;
    shipFrom?: FacilityEmbeddedInTransaction;
    designatedSeller?: UserEmbeddedInTransaction;
}
