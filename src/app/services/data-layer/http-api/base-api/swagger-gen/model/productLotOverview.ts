...
export interface ProductLotOverview { 
    readonly id?: string;
    ...
    readonly state?: ProductLotOverview.StateEnum;
    readonly permission?: ProductLotOverview.PermissionEnum;
...
export namespace ProductLotOverview {
